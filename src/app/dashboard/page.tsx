...
// palette สำหรับระบายสีบล็อกสินค้าในตารางแผนผลิต
          ...
          <div className="space-y-1.5">
            {d.planByLine.map((g) => (
              <div key={g.line} className="flex items-center gap-1">
                <div className="w-14 shrink-0 text-xs font-semibold text-slate-300">
                  {g.line}
                </div>
